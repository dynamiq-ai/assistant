...
export class UIComponents {
  ...
  static createFeedbackButtons(
    ...
    thumbsUp.className =
      selectedFeedback === 'positive'
        ? 'chat-message-feedback-button feedback-selected'
        : 'chat-message-feedback-button';
    thumbsUp.innerHTML = UIComponents.getThumbsUpIcon(
      selectedFeedback === 'positive'
    );
    ...
    thumbsDown.className =
      selectedFeedback === 'negative'
        ? 'chat-message-feedback-button feedback-selected'
        : 'chat-message-feedback-button';
    thumbsDown.innerHTML = UIComponents.getThumbsDownIcon(
      selectedFeedback === 'negative'
    );
  ...
  // Utility methods to get feedback icons
  static getThumbsUpIcon(filled: boolean = false): string {
    if (filled) {
      return '<svg width="14" height="14" viewBox="0 0 256 256" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M234,80.12A24,24,0,0,0,216,72H160V56a40,40,0,0,0-40-40,8,8,0,0,0-7.16,4.42L75.06,96H32a16,16,0,0,0-16,16v88a16,16,0,0,0,16,16H204a24,24,0,0,0,23.82-21l12-96A24,24,0,0,0,234,80.12ZM32,112H72v88H32Z"></path></svg>';
    }
  ...
  static getThumbsDownIcon(filled: boolean = false): string {
    if (filled) {
      return '<svg width="14" height="14" viewBox="0 0 256 256" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M239.82,157l-12-96A24,24,0,0,0,204,40H32A16,16,0,0,0,16,56v88a16,16,0,0,0,16,16H75.06l37.78,75.58A8,8,0,0,0,120,240a40,40,0,0,0,40-40V184h56a24,24,0,0,0,23.82-27ZM72,144H32V56H72Z"></path></svg>';
    }
